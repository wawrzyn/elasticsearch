...
public class ExternalMapper extends FieldMapper {
    ...
    public static class Builder extends FieldMapper.Builder<Builder, ExternalMapper> {
        ...
        public ExternalMapper build(BuilderContext context) {
            ...
            Mapper pointMapper = (context.indexCreatedVersion().onOrAfter(Version.V_2_1_0)) ? pointBuilder.build(context) :
    ...
    public Mapper parse(ParseContext context) throws IOException {
        ...
        if (pointMapper instanceof GeoPointFieldMapperLegacy) {
            ((GeoPointFieldMapperLegacy) (pointMapper)).parse(context.createExternalValueContext(geoPointTest));
        } else {
